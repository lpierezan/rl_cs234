...
class config_pendulum:
    def __init__(self, use_baseline):
        # self.env_name="InvertedPendulum-v1" # original env deprecated
...
class config_cheetah:
    def __init__(self, use_baseline):
        # self.env_name="HalfCheetah-v1" # original env deprecated
...
def get_config(env_name, baseline):
    ...
    elif env_name == 'pendulumGym':
        return config_pendulumGym(baseline)
